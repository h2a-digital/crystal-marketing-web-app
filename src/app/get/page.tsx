          ...
          <div className="rounded-2xl border border-[#E5E5E7] bg-white p-8 text-center shadow-xl">
            ...
            <div className="mt-12 grid gap-4 text-left sm:grid-cols-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Upload or Snap</h3>
                  <p className="text-sm text-gray-600">Use camera or gallery instantly</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Saved History</h3>
                  <p className="text-sm text-gray-600">Revisit every discovery</p>
                </div>
              </div>
            </div>
          </div>
